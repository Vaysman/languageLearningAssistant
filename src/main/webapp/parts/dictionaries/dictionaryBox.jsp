...
<div id="pl-dbox">
  ...
  <div id="pl-dbox-content">
    <div id="pl-dboxFlags">
      <ul>
        <li><img src="http://dictionarybox.com/flags/English.png" alt="english" /></li>
        <li><img src="http://dictionarybox.com/flags/Russian.png" alt="Russian" /></li>
    ...
    <div id="pl-dbox-ajax-content">
      ...
      <p><input type="text" name="pl-dbox-search-field" style="width:97%;color:black" id="pl-dbox-search-field" onKeyPress="return dbxChkKy(event);" autocomplete=off /></p>
      <p id="pl-dbox-search-button"><input type="button" value=" Search! " OnClick="getdboxResults();"/></p>
    </div>
    <input id="pl-dbox-glossary" type="hidden" value="EnglishToRussian,RussianToEnglish"/>
    <div id="pl-dbox-credit">Powered by <a href="http://www.dictionarybox.com">DictionaryBox.com</a></div></div></div>
<!-- end dictionary box -->